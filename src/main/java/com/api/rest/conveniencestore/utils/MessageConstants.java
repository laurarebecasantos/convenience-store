...
public class MessageConstants {
    ...
    public static final String CREDENTIALS_INVALID = "Credenciais: Username ou password invalidos.";
    ...
    public static final String ERROR_JWT_TOKEN = "Error generating the JWT token";
